...
function initNavs() {
    total.forEach(function (l, e) {
        ...
        (a.innerHTML = "-"), s.classList.add("moving-tab", "position-absolute", "nav-link"), s.appendChild(a), l.appendChild(s), l.getElementsByTagName("li").length;
        (s.style.padding = "0px"), (s.style.transition = ".5s ease");
        ...
        if (n) {
            ...
            if (l.classList.contains("flex-column")) {
                for (var i = 1; i <= e.indexOf(n); i++) t += l.querySelector("li:nth-child(" + i + ")").offsetHeight;
                (s.style.transform = "translate3d(0px," + t + "px, 0px)"), (s.style.width = l.querySelector("li:nth-child(" + a + ")").offsetWidth + "px"), (s.style.height = l.querySelector("li:nth-child(" + i + ")").offsetHeight);
            } else {
                for (i = 1; i <= e.indexOf(n); i++) t += l.querySelector("li:nth-child(" + i + ")").offsetWidth;
                (s.style.transform = "translate3d(" + t + "px, 0px, 0px)"), (s.style.width = l.querySelector("li:nth-child(" + a + ")").offsetWidth + "px");
            }
        }
...
window.addEventListener("resize", navbarColorOnResize),
    ...
    document.querySelector(".datepicker") && flatpickr(".datepicker", { mode: "range" });
...
function showError(e, t) {
    const a = e.parentElement,
        n = ((a.className = "input-group input-group-outline my-5 is-invalid is-filled"), a.querySelector("small"));
    n.innerText = t;
}
...
//# sourceMappingURL=/assets/js/dashboard-pro.js.map
