...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Technologies Used</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Add Technologies Used</h6>
                </nav>
        ...
        <div class="p-4" style="background-color: #fff;">
            ...
            <form action="{{ url('project_technologies_store') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-xs">{{ $new->technology }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <img src="{{asset('/upload/technology/'.$new->image)}}" height="60px">
                                </td>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                ...
                                <td class="align-middle text-center">
                                    <form method="post" class="delete_form"
                                        action="{{ route('project_technology_delete', $new->id) }}">
                                        {{ csrf_field() }}
