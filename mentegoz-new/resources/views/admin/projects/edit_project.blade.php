...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">Edit Project</h6>
                </nav>
        ...
        <div class="p-4" style="background-color: #fff;">
            ...
            <form action="{{ route('admin_project.update',$data->id) }}" method="post"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-static my-3">
                            ...
                            <select name="project_category" class="form-control">
                                @foreach($current_cat as $ccat)
                                    <option value="{{ $ccat->id }}">{{ ucfirst(trans($ccat->category)) }}</option>
                                @endforeach
                    ...
                    <div class="col-md-6">
                        <div class="input-group input-group-static my-3">
                            ...
                            <select id="tags" name="tags[]" class="form-control" multiple placeholder="Choose Tags"
                                data-allow-clear="1">
                    ...
                    <div class="col-md-6">
                            ...
                            <label style="width:100%;">Technologies Used</label>
                                ...
                                @foreach($technology as $tec)
                                    @php foreach ($ctech->technologies as $value) {
                                        ...
                                        {
                                    @endphp
                                    <option selected value="{{ $tec->id }}">{{ $tec->technology }}</option>
                                ...
                                @endphp   
                                @foreach($technology as $tec1)

                           <option value="{{$tec1->id}}">{{$tec1->technology}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-static my-3">
                                ...
                                <input type="text" name="scope" class="form-control" value="{{ $data->scope }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group input-group-static my-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="js--image-preview">
                            <img style="width: 254px;" class="upload"
                                src="{{ asset('/upload/project/lightlogo/'.$data->light_logo) }}">
                        </div>
                        <div class="input-group input-group-static">
                            <label>Project Light Logo</label>
                            <input name="light_logo" placeholder="Choose Image" class="form-control" type="file" />
                            <input type="hidden" name="img_light_logo" class="image-upload" value="{{ $data->light_logo }}">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="js--image-preview">
                            <img style="width: 254px;" class="upload"
                                src="{{ asset('/upload/project/darklogo/'.$data->dark_logo) }}">
                        </div>
                        <div class="input-group input-group-static">
                            <label>Project Dark Logo</label>
                            <input name="dark_logo" placeholder="Choose Image" class="form-control" type="file" />
                            <input type="hidden" name="img_dark_logo" class="image-upload" value="{{ $data->dark_logo }}">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="js--image-preview">
                            <img style="width: 254px;" class="upload"
                                src="{{ asset('/upload/project/'.$data->project_image) }}">
                        </div>
                        <div class="input-group input-group-static">
                            <label>Project Image</label>
                            <input name="project_image" placeholder="Choose Image" class="form-control" type="file" />
                            <input type="hidden" name="img_project_image" class="image-upload" value="{{ $data->project_image }}">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="js--image-preview">
                            <img style="width: 254px;" class="upload"
                                src="{{ asset('/upload/project/banner/'.$data->banner_image) }}">
                        </div>
                        <div class="input-group input-group-static">
                            <label>Banner Image</label>
                            <input name="banner_image" placeholder="Choose Image" class="form-control" type="file" />
                            <input type="hidden" name="img_banner_image" class="image-upload" value="{{ $data->banner_image }}">
                        </div>
                    ...
                    <div class="col-md-12 mt-5">
                        <div class="input-group input-group-static">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="2"
                                placeholder="Overview" spellcheck="false">{{ $data->description }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="input-group input-group-static my-3">
                    ...
                    <div class="col-md-6 mt-3">
                        <div class="input-group input-group-static">
                            ...
                            <textarea class="form-control" name="meta_description" rows="2"
                                spellcheck="false">{{ $data->meta_description }}</textarea>
                        </div>
                    </div>
