    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        ...
                        <h6 class="font-weight-bolder mb-0">Add Gallery Image</h6>
                    </nav>
            ...
            <div class="p-4" style="background-color: #fff;">
                ...
                <form action="{{url('project_gallery_store')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group input-group-static my-3">
                                ...
                                <input type="hidden" name="project_id" class="form-control" value="{{ basename(url()->current())}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group input-group-static my-3">
                                <label>Alt Tag</label>
                                <input type="text" name="alt_tag" class="form-control" placeholder="Alt Tag">
                            </div>
                        </div>
                ...
                <h6 class="font-weight-bolder mb-0">Gallery List</h6>
                    ...
                    <table id="datatable" class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Alt Tag</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-xs">{{$new->alt_tag}}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <img src="{{asset('/upload/project_image/gallery/'.$new->image)}}" height="60px">
                                </td>
                               
                                <td class="align-middle text-center">
                                    <form method="post" class="delete_form" action="{{route('project_gallery_delete', $new->id)}}">
                                        {{csrf_field()}}
