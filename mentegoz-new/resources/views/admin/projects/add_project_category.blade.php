...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Project Category</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Add Project Category</h6>
                </nav>
        ...
        <div class="p-4" style="background-color: #fff;">
            ...
            <form action="{{ url('project_category_store') }}" method="post">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <label>Select Parent Category</label>
                               <select class="form-control" name="parent_id">
                                ...
                                @foreach($parent_category as $new1)
                                <option value="{{ $new1->id }}">{{ $new1->category }}</option>
                                @endforeach
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-xs">{{ $new->parent_category }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-xs">{{ $new->category }}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td class="align-middle text-center">
                                    <form method="post" class="delete_form"
                                        action="{{ route('project_category_delete', $new->id) }}">
                                        {{ csrf_field() }}
