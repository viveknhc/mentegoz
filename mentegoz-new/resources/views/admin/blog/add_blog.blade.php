    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        ...
                        <h6 class="font-weight-bolder mb-0">Add New News</h6>
                    </nav>
            ...
            <div class="p-4" style="background-color: #fff;">
                ...
                <form action="{{url('news_store')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-static my-3">
                                ...
                                <input type="text" name="news_type" class="form-control" placeholder="Eg: Press Release">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-group input-group-static my-3">
                    ...
                    <label>Description</label>
                        <textarea class="form-control" name="description" rows="2"
                            placeholder="Description"spellcheck="false" id="description"></textarea>
                    </div>
                    </div>
                ...
                <h6 class="font-weight-bolder mb-0">News List</h6>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex px-2 py-1">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <h6 class="mb-0 text-xs">{{$new->slug}}</h6>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <img src="{{asset('/upload/news_image/'.$new->image)}}" height="60px">
                                </td>
                                ...
                                <td class="align-middle text-center">
                                    <a href="{{route('admin_news.edit',$new->id)}}" class="text-secondary font-weight-normal text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                        <i class="fa fa-pencil-square" aria-hidden="true"></i> &nbsp;Edit
                                    </a>
                                </td>
                                <td class="align-middle text-center">
                                    <form method="post" class="delete_form" action="{{route('news_delete', $new->id)}}">
                                        {{csrf_field()}}
