...
@include('Layout.admin_aside')
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="p-4" style="background-color: #fff;">
            ...
            <form action="{{route('admin_news.update',$data->id)}}" method="post" enctype="multipart/form-data"}}>
            {{csrf_field()}}
            {{method_field('PATCH')}}
            <div class="row">
                        <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <img style="width: 254px;" class="upload" src="{{asset('/upload/news_image/'.$data->image)}}">
                    </div>
                        <div class="input-group input-group-static">
                        <label>News Image</label>
                        <input name="image" placeholder="Choose Image" class="form-control" type="file"  />
                        <input  type="hidden" name="img_news"  class="image-upload" value="{{$data->image}}" >
                        </div>
